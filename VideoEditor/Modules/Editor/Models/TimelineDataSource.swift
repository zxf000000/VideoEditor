...
let SinglePreviewPicWidth: CGFloat = 50
...
class TimelineDataSource:NSObject, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.contentView.autoresizingMask = UIView.AutoresizingMask.init(arrayLiteral: [.flexibleWidth , .flexibleLeftMargin , .flexibleWidth , .flexibleRightMargin , .flexibleTopMargin , .flexibleHeight , .flexibleBottomMargin])
